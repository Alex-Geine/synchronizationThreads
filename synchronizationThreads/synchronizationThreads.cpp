...
// synchronizationThreads.cpp: определяет поведение классов для приложения.
//
...
// CsynchronizationThreadsApp

BEGIN_MESSAGE_MAP(CsynchronizationThreadsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CsynchronizationThreadsApp

CsynchronizationThreadsApp::CsynchronizationThreadsApp()
{
...
// Единственный объект CsynchronizationThreadsApp

CsynchronizationThreadsApp theApp;


// Инициализация CsynchronizationThreadsApp

BOOL CsynchronizationThreadsApp::InitInstance()
{
	...
	CsynchronizationThreadsDlg dlg;
	m_pMainWnd = &dlg;
